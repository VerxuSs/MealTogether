...
const PageComponent: FC = () => {
  ...
  const addNewMenu = () => {
    ...
    const newMenu = new Menu(
        newlyCreatedMenuId, newMenuName, newMenuDescription, [], []
    );
                ...
                return (
                    <div key={menu.id}>
                      ...
                      <div className="flex flex-row justify-between w-full">
                        <span className="text-gray-400 font-thin mx-2"> + add constraint</span>
                        <span className="text-gray-400 font-thin mx-2"> + add dish</span>
                      </div>
              ...
              {typingNewMenu && (
                  ...
                  >
                    <div className="bg-sky-500 h-10 w-80 flex flex-row justify-between items-center opacity-60">
                      <input className="w-full align-middle text-white font-thin mx-4 bg-transparent"
                             placeholder="Name"
                             value={newMenuName}
                    ...
                    <div className="h-10 w-80 flex flex-row justify-between items-center opacity-60">
                      <input className="w-full text-black text-xs font-thin mx-4 bg-transparent"
                    ...
                    <button className="my-4 p-1 bg-[#0e1729] text-white font-thin w-40 text-sm hover:opacity-75"
                            onClick={() => {
                              addNewMenu();
                            }
                    }
